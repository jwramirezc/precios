...
function renderProposalBenefits(containerId, isConfigurator = false) {
  ...
  const title = PROPOSAL_BENEFITS.title || '¿Qué ss tu propuesta formal?';
...
document.addEventListener('configLoaded', () => {
  ...
  const configuratorContainer = document.getElementById(
    'proposal-benefits-container-configurator'
  );
